...
public class ComplexStackTest {
    ...
    public void testGetMemory(){
        ...
        list.add(stack.pop());
        list.add(stack.pop());
        //Devo invertire perché sebbene la lista implementi uno stack, il modo in cui lo stack è salvato non coincide con il modo
        //in cui lo stack è visualizzato dalla getMemory()
    ...
    public void testDup(){
        ...
        stack.push(secondLastAfterDup);
        stack.push(lastAfterDup);
