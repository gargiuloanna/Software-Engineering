...
/**
 * This class implements a Sqrt command which makes the square root of a complex
 * number.
 */
public class SqrtCommand implements Command {
    ...
    /**
     * The method executes the operation sqrt on the ComplexNumber. It
     * calculates the square rootof the complex number. The result is pushed
     * into the stack maintained by the command.
     * <p>
